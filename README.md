...
NUBO_REGION=asia-northeast-tokyo pm2 --name demo start yarn -- start
NUBO_REGION=australia-southeast-sydney pm2 --name demo start yarn -- start
NUBO_REGION=south-america-east-sao-paulo pm2 --name demo start yarn -- start
```
